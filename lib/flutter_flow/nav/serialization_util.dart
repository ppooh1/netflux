  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case DirectorsRow:
            return DirectorsRow(data);
          case MovieActorsRow:
            return MovieActorsRow(data);
          case CategoryGoriesRow:
            return CategoryGoriesRow(data);
          case MoviesRow:
            return MoviesRow(data);
          case MovieCategorieRow:
            return MovieCategorieRow(data);
          case ActorsRow:
            return ActorsRow(data);
          default:
            return null;
        }
